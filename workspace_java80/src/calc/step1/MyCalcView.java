...
public class MyCalcView extends JFrame {
	...
	public void initDisplay() {
		...
		mcl = new MyCalcLogic(this);
		jtf_result.addActionListener(mcl);
		jbt_one.addActionListener(mcl);
		jbt_two.addActionListener(mcl);
		jbt_plus.addActionListener(mcl);
		jbt_equals.addActionListener(mcl);
		jbt_clear.addActionListener(mcl);
