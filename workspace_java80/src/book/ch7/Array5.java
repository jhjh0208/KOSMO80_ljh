...
/*
변수는 한번에 하나값만 담을 수 있디. - 장애
배열은 한번에 여러 개 값을 담을 수 있다.
그러나 다른 타입은 담을 수가 없다.[문제제기] - 객체배열, ArrayList[문제해결능력을 가진자]
또 끼워넣기가 불가하다. - 크기를 조절할 수 없다. - AttayList사용하면 문제가 해결됨.


자료구조(List계열, Map계열, Set계열) - 늘었다 줄었다 한다. 끼워넣기 가능. 회원탈퇴, 신입사원 등록
FIFO - first it first out
LIFO - last it first out
LILO...- last it last out
